...
namespace REST_WCF_Service
{
    ...
    public class EmployeeService : IEmployeeService
    {
        public EmployeeDataContract GetEmployeeDetails(string EmpId)
        {
            ...
            try
            {
                XDocument doc = XDocument.Load("E:\\DOTNET ALL FILES\\rest_wcf_service\\REST_WCF_Service\\WpfApp1\\EmployeeData.xml");
        ...
        public bool AddNewEmployee(EmployeeDataContract employee)
        {
            try
            {
                ...
                doc.Save("E:\\DOTNET ALL FILES\\rest_wcf_service\\REST_WCF_Service\\WpfApp1\\EmployeeData.xml");
            }
            catch (Exception ex)
            {
                throw new FaultException<string>
