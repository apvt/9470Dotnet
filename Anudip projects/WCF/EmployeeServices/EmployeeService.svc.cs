    ...
    public class Service1 : IEmployeeService
    {
        ...
        public string AddEmployyeeRecord(Employee emp)
        {
            ...
            try
            {
                ...
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-EHTH26K;Initial Catalog=apoorva; Integrated Security=True");
                SqlCommand cmd = new SqlCommand();

                string Query = @"Insert into tblEmployee(EmpID,Name,Email,Phone,Gender) values(@EmpID,@Name,@Email,@Phone,@Gender)";
